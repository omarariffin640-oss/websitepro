...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 border-purple-500/20"> {/* ✅ GANTI glass */}
      ...
      {/* ===== CHALLENGES SECTION ===== */}
      <section className="py-20 bg-gray-900/50"> {/* ✅ GANTI bg-darknavy/50 */}
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {challenges.map((challenge, i) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: i * 0.1 }}
              >
                <Card className="bg-white/5 backdrop-blur-sm border border-white/10 hover:border-purple-500/30 transition-all duration-300 hover:scale-105"> {/* ✅ GANTI glass-card */}
                  <CardHeader>
          ...
          <motion.div
            ...
            className="mt-8"
          >
            <Card className="bg-white/5 backdrop-blur-sm border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300"> {/* ✅ GANTI glass-card */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {features.map((feature, i) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: i * 0.1 }}
              >
                <Card className="bg-white/5 backdrop-blur-sm border border-white/10 text-center hover:border-purple-500/30 transition-all duration-300"> {/* ✅ GANTI glass-card */}
      ...
      <section className="py-20 border-t border-gray-800">
        <div className="container mx-auto px-4">
          <div className="bg-white/5 backdrop-blur-sm border border-purple-500/20 rounded-2xl p-8 md:p-12 text-center max-w-4xl mx-auto"> {/* ✅ GANTI glass */}
