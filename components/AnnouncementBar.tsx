    ...
    return (
        <div className="fixed left-0 right-0 top-0 z-50 border-b border-purple-500/20 bg-black/95 backdrop-blur-xl">
            <div className="container mx-auto px-4">
                <div className="flex min-h-[40px] items-center justify-center gap-2 overflow-hidden text-xs sm:min-h-[48px] sm:justify-between sm:text-sm">
                    <div className="flex flex-wrap items-center justify-center gap-2">
                        <span className="flex items-center gap-1 rounded-full bg-purple-500/20 px-2 py-1 text-xs font-bold text-purple-300 sm:px-3 sm:text-sm md:text-base">
