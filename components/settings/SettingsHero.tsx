            ...
            <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p className="mt-5 max-w-2xl leading-7 text-zinc-400">
                        Manage notifications, email alerts and account security preferences.
                    </p>

                    <div className="mt-8 flex flex-wrap gap-3">
                        <Badge icon={Bell} text={notifications ? "Notifications On" : "Notifications Off"} />
                        <Badge icon={Mail} text={emailAlerts ? "Email Alerts On" : "Email Alerts Off"} />
                        <Badge icon={Shield} text={twoFactor ? "2FA Enabled" : "Basic Security"} />
                    </div>
                </div>
